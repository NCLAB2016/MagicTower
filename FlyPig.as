package 
{
	...
	public class FlyPig extends MovieClip
	{
		public static var hasMeet:Boolean;
		public static var bloodPercent:uint;

		private var _enemyType:uint = Enemy.FLYPIG;
		private var _blood:int = 3000;
		private var _attack:uint = 80;
		private var _defence:uint = 40;
		private var _gold:uint = 12;
		private var _exp:uint = 12;

		private var _exist:Boolean;


		public function FlyPig()
		{
			visible = false;
			_exist = false;
