package 
{
	...
	public class BaiZe extends MovieClip
	{
		public static var hasMeet:Boolean;

		public static var bloodPercent:uint;

		private var _enemyType:uint = Enemy.BAIZE;
		private var _blood:int = 5000;
		private var _attack:uint = 100;
		private var _defence:uint = 50;
		private var _gold:uint = 20;
		private var _exp:uint = 20;

		private var _exist:Boolean;


		public function BaiZe()
		{
			visible = false;
			_exist = false;
		...
		private function onEnterFrame(event:Event):void
		{
			...
			if (parent != null)
			{
				_exist = true;
				visible  = true;
				MovieClip(parent).checkCollisionWithPlayer_BaiZe(this);
