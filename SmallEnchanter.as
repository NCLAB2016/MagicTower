package 
{
	...
	public class SmallEnchanter extends MovieClip
	{
		//用于更新图鉴
		...
		private var _enemyType:uint = Enemy.SMALL_ENCHANTER;
		private var _blood:int = 1000;
		private var _attack:uint = 50;
		private var _defence:uint = 50;
		private var _gold:uint = 5;
		private var _exp:uint = 5;

		private var _exist:Boolean;


		public function SmallEnchanter()
		{
