package 
{
	...
	public class BigGhost extends MovieClip
	{
		//用于更新图鉴
		...
		private var _enemyType:uint = Enemy.BIG_GHOST;
		private var _blood:int = 500;
		private var _attack:uint = 15;
		private var _defence:uint = 2;
		private var _gold:uint = 2;
		private var _exp:uint = 3;

		private var _exist:Boolean;

		public function BigGhost()
		{
			visible = false;
			_exist = false;
