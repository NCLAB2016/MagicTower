package 
{
	...
	public class SmallGhost extends MovieClip
	{
		//用于更新图鉴
		...
		private var _enemyType:uint = Enemy.SMALL_GHOST;
		private var _blood:int = 450;
		private var _attack:uint = 12;
		private var _defence:uint = 1;
		private var _gold:uint = 1;
		private var _exp:uint = 2;

		private var _exist:Boolean;


		public function SmallGhost()
		{
			visible = false;
			_exist = false;
